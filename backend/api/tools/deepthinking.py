...
class DeepThinkingTool(Tool):
    ...
    inputs = {
        "question": {"type": "string", "description": "The humanities question or topic", "nullable": True},
        "output_path": {"type": "string", "description": "Path to save the output (optional)", "nullable": True}
    }
    output_type = "string"
